...
import { CauseAndEffectQuestion as CaeType, User } from '../../../types';
...
const CauseAndEffectQuestion: React.FC<CaeProps> = ({ question, onAnswer, onContinue, user }) => {
...
export default CauseAndEffectQuestion;